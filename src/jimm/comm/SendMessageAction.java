...
public class SendMessageAction extends Action
{
	...
	private void initPlainMsg() throws JimmException
	{
        ...
        // #sijapp cond.if target is "MIDP2" | target is "MOTOROLA" | target is "SIEMENS2"#
        // #sijapp cond.if modules_FILES is "true"#
        if ((this.fileTrans != null) && (rcvr.getIntValue(ContactItem.CONTACTITEM_STATUS) != ContactList.STATUS_OFFLINE))
        {
            type = 2;
        }
        // #sijapp cond.end#
        ...
        {
            // Get UIN
            byte[] uinRaw = Util.stringToByteArray(rcvr.getStringValue(ContactItem.CONTACTITEM_UIN));
            ...
            // Send packet
            SnacPacket snacPkt = new SnacPacket
									(
