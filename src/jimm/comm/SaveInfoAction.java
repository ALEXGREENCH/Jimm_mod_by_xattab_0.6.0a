...
public class SaveInfoAction extends Action
{
	...
	private static final int INTEREST_TLV_ID  = 0x01EA;
	...
	protected synchronized void init() throws JimmException
	{
		...
		/* Home Page */
		Util.writeAsciizTLV(HOME_PAGE_TLV_ID, stream, strData[JimmUI.UI_HOME_PAGE], false);

		/* Notes */
		Util.writeAsciizTLV(ABOUT_TLV_ID, stream, strData[JimmUI.UI_ABOUT], false);

		/* Sity */
		Util.writeAsciizTLV(CITY_TLV_ID, stream, strData[JimmUI.UI_CITY], false);

		Util.writeAsciizTLVInterest(INTEREST_TLV_ID, stream, RequestInfoAction.indexCategories[0], strData[JimmUI.UI_INETRESTS_1]);
		Util.writeAsciizTLVInterest(INTEREST_TLV_ID, stream, RequestInfoAction.indexCategories[1], strData[JimmUI.UI_INETRESTS_2]);
		Util.writeAsciizTLVInterest(INTEREST_TLV_ID, stream, RequestInfoAction.indexCategories[2], strData[JimmUI.UI_INETRESTS_3]);
		Util.writeAsciizTLVInterest(INTEREST_TLV_ID, stream, RequestInfoAction.indexCategories[3], strData[JimmUI.UI_INETRESTS_4]);
